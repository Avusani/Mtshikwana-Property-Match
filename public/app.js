...
// FORM HANDLING
// ========================================
document.getElementById('tenantRegisterForm').addEventListener('submit', async function(e) {
  e.preventDefault();
  const data = {
    id: 'tn_' + Date.now(),
...
document.getElementById('landlordRegisterForm').addEventListener('submit', async function(e) {
  e.preventDefault();
  const data = {
    id: 'ld_' + Date.now(),
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Also handle if data is already loaded
  setTimeout(() => {
